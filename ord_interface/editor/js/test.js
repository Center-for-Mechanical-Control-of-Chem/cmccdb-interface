...
(async () => {
  ...
  page.goto('http://localhost:80/editor/authenticate');
  await page.waitForNavigation();

  // Round-trip these reactions through the DOM and compare at the server.
  const roundtripTests = [
    'http://localhost:80/editor/dataset/empty/reaction/0',
    'http://localhost:80/editor/dataset/full/reaction/0',
    'http://localhost:80/editor/dataset/ord-nielsen-example/reaction/0',
  ];
  ...
  const validationTests = [
    'http://localhost:8080/editor/dataset/ord-nielsen-example/reaction/0',
  ];
